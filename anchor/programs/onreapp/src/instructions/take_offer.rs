...
pub fn take_offer_one(ctx: Context<TakeOfferOne>, sell_token_amount: u64) -> Result<()> {
  ...
  require!(offer.sell_token_mint == ctx.accounts.user_sell_token_account.mint, TakeOfferErrorCode::InvalidSellTokenMint);
  require!(offer.buy_token_mint_1 == ctx.accounts.user_buy_token_1_account.mint, TakeOfferErrorCode::InvalidBuyTokenMint);
  require!(ctx.accounts.offer_sell_token_account.amount + sell_token_amount <= offer.sell_token_total_amount, TakeOfferErrorCode::OfferExceedsSellLimit);

  require!(offer.buy_token_mint_2 == system_program::ID, TakeOfferErrorCode::InvalidTakeOffer);
  ...
  require!(ctx.accounts.offer_buy_token_1_account.amount >= buy_token_1_amount, TakeOfferErrorCode::InsufficientOfferBalance);
  ...
  let seeds = &[b"offer_authority".as_ref(), offer_id_bytes, &[offer.authority_bump]];
...
pub fn take_offer_two(ctx: Context<TakeOfferTwo>, sell_token_amount: u64) -> Result<()> {
  ...
  require!(offer.buy_token_mint_2 == ctx.accounts.user_buy_token_2_account.mint, TakeOfferErrorCode::InvalidBuyTokenMint);
